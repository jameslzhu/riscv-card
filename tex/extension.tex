...
\multicolumn{1}{c|}{opcode} \\
\hline
FADD/FSUB & S & src2 & src1 & RM  & dest & OP-FP (R)
\end{tabular}
\begin{tabular}{R@{}F@{}R@{}R@{}F@{}R@{}O}
\\
\instbitrange{31}{27} &
...
\rm Inst  & Name                    & FMT   & \rm Opcode & \rm funct3 & \rm funct5 & \rm Description (C) & \rm Note \\ \hline
...
fnmadd.s  & Flt Neg [Fused Mul-Add] & R     &            &        &        & rd = -(rs1 * rs2) - rs3 & [sic] \\
fnmsub.s  & Flt Neg [Fused Mul-Sub] & R     &            &        &        & rd = -(rs1 * rs2) + rs3 & [sic] \\
