...
\rhead{\headerfont V0.5}
\rfoot{(c) James Zhu, 2018-2024 (\href{https://creativecommons.org/licenses/by/4.0/}{CC-BY-4.0})}

%% Title %%

\pretitle{\vspace{-0.75in}\begin{center} \huge \bfseries}
\title{RISC-V Reference}
\posttitle{\end{center}}
\preauthor{\begin{center} \sffamily}
\author{James Zhu <jameszhu@protonmail.com>}
